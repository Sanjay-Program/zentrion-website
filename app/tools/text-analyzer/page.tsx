    ...
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 glass-card rounded-2xl border border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] backdrop-blur-md flex flex-col overflow-hidden h-[600px]">
            <div className="px-6 py-4 border-b border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] flex justify-between items-center shrink-0">
              <h3 className="text-[rgb(var(--c-ink))] font-semibold">Input Text</h3>
              <button
                onClick={clearText}
            ...
            <textarea
              ...
              className="flex-grow p-6 bg-transparent text-[rgb(var(--c-ink))] font-mono text-base leading-relaxed focus:outline-none resize-none custom-scrollbar whitespace-pre-wrap"
              spellCheck="false"
            />
          </div>
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="glass-card rounded-2xl border border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] backdrop-blur-md p-6">
              ...
              <div className="text-4xl font-display font-bold text-[rgb(var(--c-ink))]">{metrics.words.toLocaleString()}</div>
            </div>

            <div className="glass-card rounded-2xl border border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] backdrop-blur-md p-6">
              <h3 className="text-[rgb(var(--c-mute))] text-xs uppercase tracking-wider font-semibold mb-2">Character Count</h3>
              <div className="flex items-end gap-3">
                <div className="text-4xl font-display font-bold text-[rgb(var(--c-ink))]">{metrics.chars.toLocaleString()}</div>
                <div className="text-[rgb(var(--c-mute))] pb-1 text-sm">with spaces</div>
              </div>
              <div className="mt-4 pt-4 border-t border-[var(--c-glass-border)] flex items-end gap-3">
                <div className="text-2xl font-display font-bold text-[rgb(var(--c-ink))]/80">{metrics.charsNoSpaces.toLocaleString()}</div>
                <div className="text-[rgb(var(--c-mute))] pb-0.5 text-sm">without spaces</div>
              </div>
            </div>

            <div className="glass-card rounded-2xl border border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] backdrop-blur-md p-6 grid grid-cols-2 gap-4">
              <div>
                <h3 className="text-[rgb(var(--c-mute))] text-xs uppercase tracking-wider font-semibold mb-1">Sentences</h3>
                <div className="text-2xl font-bold text-[rgb(var(--c-ink))]">{metrics.sentences.toLocaleString()}</div>
              </div>
              <div>
                <h3 className="text-[rgb(var(--c-mute))] text-xs uppercase tracking-wider font-semibold mb-1">Paragraphs</h3>
                <div className="text-2xl font-bold text-[rgb(var(--c-ink))]">{metrics.paragraphs.toLocaleString()}</div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl border border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] backdrop-blur-md p-6">
              ...
              <div className="text-2xl font-bold text-[rgb(var(--c-ink))]">
