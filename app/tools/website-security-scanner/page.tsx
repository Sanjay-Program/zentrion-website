...
export const metadata: Metadata = {
  title: 'Website Security Scanner | Zentrion Cyber Tools',
  description: 'AI-powered all-in-one domain security audit.',
};

export default function WebsiteSecurityScannerPage() {
  return (
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-[rgb(var(--c-mute))]">AI-powered all-in-one domain security audit.</p>
          <div className="mt-4">
