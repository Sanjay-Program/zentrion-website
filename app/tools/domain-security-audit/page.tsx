...
export const metadata: Metadata = {
  title: 'Domain Security Audit | Zentrion Cyber Tools',
  description: 'Comprehensive domain security analysis.',
};

export default function DomainSecurityAuditPage() {
  return (
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold font-display tracking-tight mb-4">Domain Security Audit</h1>
          <p className="text-xl text-[rgb(var(--c-mute))]">Comprehensive domain security analysis.</p>
          <div className="mt-4">
