...
export const metadata: Metadata = {
  title: 'Reverse IP Lookup | Zentrion Cyber Tools',
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold font-display tracking-tight mb-4">Reverse IP Lookup</h1>
          <p className="text-xl text-[rgb(var(--c-mute))]">Find domains hosted on the same IP.</p>
          <div className="mt-4">
