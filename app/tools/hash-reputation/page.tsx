...
export const metadata: Metadata = {
  title: 'Hash Reputation | Zentrion Cyber Tools',
  description: 'Look up malware hashes across AV databases.',
};

export default function HashReputationPage() {
  return (
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold font-display tracking-tight mb-4">Hash Reputation</h1>
          <p className="text-xl text-[rgb(var(--c-mute))]">Look up malware hashes across AV databases.</p>
          <div className="mt-4">
