...
export const metadata: Metadata = {
  title: 'DNS Propagation Checker | Zentrion Cyber Tools',
  description: 'Check global DNS record propagation status.',
};
    ...
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-[rgb(var(--c-mute))]">Check global DNS record propagation status.</p>
          <div className="mt-4">
