...
export const metadata: Metadata = {
  title: 'Hash Generator | Zentrion Cyber Tools',
  description: 'Compute secure hashes for text and files.',
};
    ...
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-[rgb(var(--c-mute))]">Compute secure hashes for text and files.</p>
          <div className="mt-4">
