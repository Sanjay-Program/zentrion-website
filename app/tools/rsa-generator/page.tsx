  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--c-void))] text-[rgb(var(--c-ink))] pt-32 pb-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="glass-card rounded-2xl border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,0.02)] backdrop-blur-md p-6 sm:p-8 mb-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex-grow">
            <label className="block text-sm font-semibold text-white mb-3">Key Size (Modulus Length)</label>
            <div className="flex flex-wrap gap-3">
              <label className={`px-4 py-2 border rounded-lg cursor-pointer transition-all ${keySize === 2048 ? 'bg-[rgb(var(--c-accent))] border-[rgb(var(--c-accent))] text-[rgb(var(--c-void))] font-bold' : 'bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.1)] text-white hover:border-[rgba(255,255,255,0.3)]'}`}>
                <input type="radio" checked={keySize === 2048} onChange={() => setKeySize(2048)} className="sr-only" />
                2048-bit (Standard)
              </label>
              <label className={`px-4 py-2 border rounded-lg cursor-pointer transition-all ${keySize === 4096 ? 'bg-[rgb(var(--c-accent))] border-[rgb(var(--c-accent))] text-[rgb(var(--c-void))] font-bold' : 'bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.1)] text-white hover:border-[rgba(255,255,255,0.3)]'}`}>
