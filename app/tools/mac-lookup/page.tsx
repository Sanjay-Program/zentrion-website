          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl overflow-hidden flex items-stretch">
              ...
              <div className="p-6">
                ...
                <h2 className="text-3xl font-display font-bold text-[rgb(var(--c-ink))]">{result.company}</h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[var(--c-glass-bg)] border border-[var(--c-glass-border)] rounded-2xl overflow-hidden">
                <div className="border-b border-[var(--c-glass-border)] bg-[var(--c-glass-bg)] px-6 py-4">
                  <h3 className="text-[rgb(var(--c-ink))] font-bold flex items-center gap-2">
                ...
                <div className="p-6 space-y-4">
                  <div>
                    ...
                    <div className="text-[rgb(var(--c-ink))]">{result.company}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-[rgb(var(--c-ink))] text-sm leading-relaxed">{result.address || 'Address not registered in IEEE database.'}</div>
                  </div>
                  <div>
                    <div className="text-[rgb(var(--c-mute))] text-xs uppercase tracking-wider font-semibold mb-1">Country</div>
                    <div className="text-[rgb(var(--c-ink))] text-sm">{result.country || 'Unknown'}</div>
                  </div>
                </div>
              </div>
